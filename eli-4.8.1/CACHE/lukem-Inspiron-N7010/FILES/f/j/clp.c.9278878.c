...
static opt opts[] = {
    { "-p", STRVAL | SPACED, &Prefix_count, &Prefix, NULL },
...
#endif
{
  ...
  fprintf (stderr, "    -p string prefix to be used for generated attribute\n");
  fprintf (stderr, "  Parameters:\n");
  fprintf (stderr, "    InputFile input file name\n");
    exit (1);
}
