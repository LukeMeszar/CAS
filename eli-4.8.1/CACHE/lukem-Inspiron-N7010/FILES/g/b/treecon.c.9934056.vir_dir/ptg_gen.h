...
PTGNode PTGEmpty ELI_ARG((CONST char* p1, CONST char* p2));
...
PTGNode PTGdtd ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGEntityDef ELI_ARG((CONST char* p1, PTGNode p2));
PTGNode PTGElement ELI_ARG((CONST char* p1, PTGNode p2));
PTGNode PTGContent ELI_ARG((PTGNode p1));
PTGNode PTGListContent ELI_ARG((PTGNode p1));
PTGNode PTGEntityUse ELI_ARG((CONST char* p1));
