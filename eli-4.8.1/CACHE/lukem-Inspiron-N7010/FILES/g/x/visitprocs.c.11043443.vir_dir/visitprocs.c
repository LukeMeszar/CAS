...
PTGNode _AVLST_xGrammar__const14;
int _AVLST_xGrammar__const15;
PTGNode _AVLST_xGrammar__const16;
...
PTGNode _AVLST_Syms__const13;
PTGNode _AVLST_Items__const0;
int _AVxRoot_HasListof;
CharPtr _AVxRoot_ModuleBasename;
...
PTGNode _AVxGrammar__const14;
int _AVxGrammar__const15;
PTGNode _AVxGrammar__const16;
...
PTGNode _AS1_const12;
PTGNode _AS1_const13;
int _AS1IsListof;
PTGNode _AS1Class;
...
_VisitVarDecl()
_VisitEntry();
(*(_CALL_VS_((NODEPTR ,PTGNode*,PTGNode*,int*,PTGNode*,PTGNode*,PTGNode*)) (VS2MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1,(&( _AS1TreeGram)),(&( _AS1Class)),(&( _AS1IsListof)),(&( _AS1_const13)),(&( _AS1_const12)),(&( _AS1_const11)));
...
/*SPC(127)*/
_AVLST_xGrammar__const12=PTGSeq(_AS1_const12, _AVLST_xGrammar__const12);
/*SPC(127)*/
_AVLST_xGrammar__const13=PTGSeq(_AS1_const13, _AVLST_xGrammar__const13);
/*SPC(127)*/
_AVLST_xGrammar__const14=PTGSeq(IDENTICAL(_AS1Class), _AVLST_xGrammar__const14);
/*SPC(127)*/
_AVLST_xGrammar__const15=OR(IDENTICAL(_AS1IsListof), _AVLST_xGrammar__const15);
/*SPC(127)*/
_AVLST_xGrammar__const16=PTGSeq(IDENTICAL(_AS1TreeGram), _AVLST_xGrammar__const16);
/*SPC(127)*/
...
/*SPC(127)*/
_AVLST_xGrammar__const14=PTGNull();
/*SPC(127)*/
_AVLST_xGrammar__const15=ZERO();
/*SPC(127)*/
_AVLST_xGrammar__const16=PTGNull();
/*SPC(127)*/
...
/*SPC(0)*/
(*(_CALL_VS_((NODEPTR ,PTGNode*,PTGNode*,PTGNode*,PTGNode*,PTGNode*,PTGNode*,PTGNode*)) (VS3MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1,(&( _AS1TreeGram)),(&( _AS1Insert)),(&( _AS1Declare)),(&( _AS1Argument)),(&( _AS1Assign)),(&( _AS1Access)),(&( _AS1_const13)));
...
/*SPC(132)*/
_AVLST_xRHS__const13=PTGSeq(_AS1_const13, _AVLST_xRHS__const13);
/*SPC(132)*/
...
_VisitEntry();
(*(_CALL_VS_((NODEPTR )) (VS2MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1);
(*(_CALL_VS_((NODEPTR ,PTGNode*,PTGNode*,PTGNode*)) (VS3MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1,(&( _AS1Ptg)),(&( _AS1AttrPtg)),(&( _AS1Class)));
(*(_CALL_VS_((NODEPTR )) (VS2MAP[_currn->_desc2->_prod])))((NODEPTR) _currn->_desc2);
...
/*SPC(133)*/
_AVLST_Syms__const13=PTGSeq(IDENTICAL(_AS1Class), _AVLST_Syms__const13);
/*SPC(133)*/
...
#if defined(__STDC__) || defined(__cplusplus)
void _VS3rule_11(_TPPrule_11 _currn,PTGNode* _AS0TreeGram,PTGNode* _AS0Insert,PTGNode* _AS0Declare,PTGNode* _AS0Argument,PTGNode* _AS0Assign,PTGNode* _AS0Access,PTGNode* _AS0_const13)
#else
void _VS3rule_11(_currn ,_AS0TreeGram,_AS0Insert,_AS0Declare,_AS0Argument,_AS0Assign,_AS0Access,_AS0_const13)
_TPPrule_11 _currn;
PTGNode* _AS0_const13;
PTGNode* _AS0Access;
PTGNode* _AS0Assign;
...
#if defined(__STDC__) || defined(__cplusplus)
void _VS3rule_12(_TPPrule_12 _currn,PTGNode* _AS0TreeGram,PTGNode* _AS0Insert,PTGNode* _AS0Declare,PTGNode* _AS0Argument,PTGNode* _AS0Assign,PTGNode* _AS0Access,PTGNode* _AS0_const13)
#else
void _VS3rule_12(_currn ,_AS0TreeGram,_AS0Insert,_AS0Declare,_AS0Argument,_AS0Assign,_AS0Access,_AS0_const13)
_TPPrule_12 _currn;
PTGNode* _AS0_const13;
PTGNode* _AS0Access;
PTGNode* _AS0Assign;
...
_VisitEntry();
(*(_CALL_VS_((NODEPTR ,PTGNode*,PTGNode*,PTGNode*)) (VS3MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1,(&( _AS1Ptg)),(&( _AS1AttrPtg)),(&( _AS1Class)));
(* _AS0_const13)=IDENTICAL(_AS1Class);
/*SPC(136)*/
_AVLST_xRHScnt_post=ADD(_AVElementcnt_pre, 1);
/*SPC(550)*/
_AVLST_xRHSTermCnt_post=_AVElementTermCnt_pre;
...
#if defined(__STDC__) || defined(__cplusplus)
void _VS3rule_13(_TPPrule_13 _currn,PTGNode* _AS0TreeGram,PTGNode* _AS0Insert,PTGNode* _AS0Declare,PTGNode* _AS0Argument,PTGNode* _AS0Assign,PTGNode* _AS0Access,PTGNode* _AS0_const13)
#else
void _VS3rule_13(_currn ,_AS0TreeGram,_AS0Insert,_AS0Declare,_AS0Argument,_AS0Assign,_AS0Access,_AS0_const13)
_TPPrule_13 _currn;
PTGNode* _AS0_const13;
PTGNode* _AS0Access;
PTGNode* _AS0Assign;
...
/*SPC(133)*/
_AVSyms__const13=_AVLST_Syms__const13;
/*SPC(133)*/
...
/*SPC(132)*/
_AVxRHS__const13=_AVLST_xRHS__const13;
/*SPC(132)*/
...
#if defined(__STDC__) || defined(__cplusplus)
void _VS2rule_16(_TPPrule_16 _currn,PTGNode* _AS0TreeGram,PTGNode* _AS0Class,int* _AS0IsListof,PTGNode* _AS0_const13,PTGNode* _AS0_const12,PTGNode* _AS0_const11)
#else
void _VS2rule_16(_currn ,_AS0TreeGram,_AS0Class,_AS0IsListof,_AS0_const13,_AS0_const12,_AS0_const11)
_TPPrule_16 _currn;
PTGNode* _AS0_const11;
PTGNode* _AS0_const12;
PTGNode* _AS0_const13;
int* _AS0IsListof;
PTGNode* _AS0Class;
PTGNode* _AS0TreeGram;
...
_VisitEntry();
(*(_CALL_VS_((NODEPTR )) (VS2MAP[_currn->_desc2->_prod])))((NODEPTR) _currn->_desc2);
(*(_CALL_VS_((NODEPTR ,PTGNode*,PTGNode*,PTGNode*)) (VS3MAP[_currn->_desc2->_prod])))((NODEPTR) _currn->_desc2,(&( _AS2Ptg)),(&( _AS2AttrPtg)),(&( _AS2Class)));
(*(_CALL_VS_((NODEPTR )) (VS2MAP[_currn->_desc3->_prod])))((NODEPTR) _currn->_desc3);
(* _AS0_const11)=IDENTICAL(_currn->_desc1->_ATFwd);
/*SPC(130)*/
(* _AS0_const12)=IDENTICAL(_currn->_desc1->_ATVisit);
/*SPC(130)*/
(* _AS0_const13)=PTGSeq(IDENTICAL(_AS2Class), _AVSyms__const13);
/*SPC(130)*/
...
(* _AS0IsListof)=1;
/*SPC(514)*/
(* _AS0Class)=PTGListofProdClass(StringTable(_currn->_desc1->_ATSym), _AS2Ptg, (* _IG_incl4));
/*SPC(588)*/
...
#if defined(__STDC__) || defined(__cplusplus)
void _VS2rule_17(_TPPrule_17 _currn,PTGNode* _AS0TreeGram,PTGNode* _AS0Class,int* _AS0IsListof,PTGNode* _AS0_const13,PTGNode* _AS0_const12,PTGNode* _AS0_const11)
#else
void _VS2rule_17(_currn ,_AS0TreeGram,_AS0Class,_AS0IsListof,_AS0_const13,_AS0_const12,_AS0_const11)
_TPPrule_17 _currn;
PTGNode* _AS0_const11;
PTGNode* _AS0_const12;
PTGNode* _AS0_const13;
...
(* _AS0_const12)=IDENTICAL(_currn->_desc1->_ATVisit);
/*SPC(129)*/
(* _AS0_const13)=PTGSeq(IDENTICAL(_AS2Class), _AVxRHS__const13);
/*SPC(129)*/
_AVG2PtgTemplates_post=
((GetNoPtgGiven(_currn->_desc1->_ATKey, 1)
...
(* _AS0IsListof)=0;
/*SPC(509)*/
(* _AS0Class)=PTGProductionClass(StringTable(_currn->_desc1->_ATSym), _AS2Ptg, _AVxRHS__const6, _AVxRHS__const7, _AVxRHS__const8, 
((EQ(_AVxProduction_Declare_RuleAttr_67, PTGNULL)
) ? (PTGNULL
) : (PTGVars(_AVxProduction_Declare_RuleAttr_67)))
, (* _IG_incl4));
/*SPC(535)*/
...
/*SPC(127)*/
_AVxGrammar__const14=_AVLST_xGrammar__const14;
/*SPC(127)*/
_AVxGrammar__const15=_AVLST_xGrammar__const15;
/*SPC(127)*/
_AVxGrammar__const16=_AVLST_xGrammar__const16;
/*SPC(127)*/
...
#if defined(__STDC__) || defined(__cplusplus)
void _VS3rule_26(_TPPrule_26 _currn,PTGNode* _AS0Ptg,PTGNode* _AS0AttrPtg,PTGNode* _AS0Class)
#else
void _VS3rule_26(_currn ,_AS0Ptg,_AS0AttrPtg,_AS0Class)
_TPPrule_26 _currn;
PTGNode* _AS0Class;
PTGNode* _AS0AttrPtg;
PTGNode* _AS0Ptg;
...
) ? (PTGSymbolClass((* _AS0Ptg), (* _IG_incl4))
) : (PTGNULL))
;
/*SPC(519)*/
...
#if defined(__STDC__) || defined(__cplusplus)
void _VS3rule_25(_TPPrule_25 _currn,PTGNode* _AS0Ptg,PTGNode* _AS0AttrPtg,PTGNode* _AS0Class)
#else
void _VS3rule_25(_currn ,_AS0Ptg,_AS0AttrPtg,_AS0Class)
_TPPrule_25 _currn;
PTGNode* _AS0Class;
PTGNode* _AS0AttrPtg;
PTGNode* _AS0Ptg;
...
/*SPC(490)*/
_currn->_ATFwd=PTGForward(StringTable(_currn->_ATSym));
/*SPC(489)*/
...
(*(_CALL_VS_((NODEPTR )) (VS2MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1);
(*(_CALL_VS_((NODEPTR )) (VS2MAP[_currn->_desc2->_prod])))((NODEPTR) _currn->_desc2);
_AVxRoot_HasListof=_AVxGrammar__const15;
/*SPC(499)*/
_AVxRoot_ModuleBasename=CatStrStr("treeDef/", _currn->_ATPrefix);
/*SPC(501)*/
_AVxRoot_TreeGram=_AVxGrammar__const16;
/*SPC(361)*/
...
/*SPC(411)*/
PTGOutFile(CatStrStr(_AVxRoot_ModuleBasename, ".h"), PTGHeader(_currn->_ATPrefix, _AVxGrammar__const11, _AVxGrammar__const12, 
((_AVxRoot_HasListof
) ? (PTGDeclareCombine(_currn->_ATPrefix)
) : (PTGNULL))
, _AVxGrammar__const13, _AVxGrammar__const14));
/*SPC(485)*/

if (_AVxRoot_HasListof) {
PTGOutFile(CatStrStr(_AVxRoot_ModuleBasename, ".cc"), PTGCombine(_currn->_ATPrefix));
