...
PTGNode PTGPDL ELI_ARG((PTGNode p1));
PTGNode PTGTypeProperty ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGOperatorProperty ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGMultOperator ELI_ARG((PTGNode p1));
PTGNode PTGClassProperty ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGHeader ELI_ARG((PTGNode p1));
PTGNode PTGTypeSymbol ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGOperatorSymbol ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGClassSymbol ELI_ARG((PTGNode p1, PTGNode p2));
