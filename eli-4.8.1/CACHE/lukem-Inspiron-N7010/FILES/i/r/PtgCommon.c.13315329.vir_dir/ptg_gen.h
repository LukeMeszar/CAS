...
PTGNode PTGBurg ELI_ARG((PTGNode p1, PTGNode p2, PTGNode p3, PTGNode p4, PTGNode p5, PTGNode p6));
PTGNode PTGInclude ELI_ARG((PTGNode p1));
PTGNode PTGHeader ELI_ARG((PTGNode p1, PTGNode p2, PTGNode p3));
PTGNode PTGTerm ELI_ARG((PTGNode p1, int p2));
PTGNode PTGMacro ELI_ARG((PTGNode p1, int p2));
PTGNode PTGPattern ELI_ARG((PTGNode p1, int p2, int p3, PTGNode p4));
PTGNode PTGCommute ELI_ARG((PTGNode p1, PTGNode p2, PTGNode p3, PTGNode p4, PTGNode p5));
PTGNode PTGBuild0 ELI_ARG((PTGNode p1, PTGNode p2, PTGNode p3, PTGNode p4, PTGNode p5));
PTGNode PTGBuild1 ELI_ARG((PTGNode p1, PTGNode p2, PTGNode p3, PTGNode p4, PTGNode p5));
PTGNode PTGBuild2 ELI_ARG((PTGNode p1, PTGNode p2, PTGNode p3, PTGNode p4, PTGNode p5));
PTGNode PTGFieldDecl ELI_ARG((PTGNode p1, int p2));
PTGNode PTGArgDecl ELI_ARG((PTGNode p1, int p2));
PTGNode PTGArgName ELI_ARG((int p1));
PTGNode PTGFieldSet ELI_ARG((int p1));
PTGNode PTGExtern0 ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGExtern1 ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGExtern2 ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGReducer ELI_ARG((PTGNode p1, PTGNode p2, PTGNode p3, int p4));
PTGNode PTGForward ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGCase ELI_ARG((int p1, PTGNode p2, PTGNode p3));
PTGNode PTGReducerCall ELI_ARG((PTGNode p1, int p2));
PTGNode PTGGetValue ELI_ARG((PTGNode p1, int p2));
PTGNode PTGTransform ELI_ARG((PTGNode p1, PTGNode p2));
PTGNode PTGTransformDecl ELI_ARG((PTGNode p1, PTGNode p2));
